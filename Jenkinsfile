node {
   ...
   stage('Run NeoLoad - scenario1') {
        ...
        //PerfSig record test
    		recordDynatraceCustomSession(entityIds: [[$class: 'Service', entityId: 'SERVICE-2A07FD2D00BA8372']], envId: 'DTSaaS', testCase: 'loadtest', timeframeStart: "${TEST_START}", timeframeStop: 0){
    	// Test scenario
    	//NeoLoad Test 
